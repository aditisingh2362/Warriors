...
const LifestyleCard = (props) => {
    return (
        <View style={[styles.container, {backgroundColor: props.bgcolor}]} >
            ...
            <View style={{marginVertical: 10, marginLeft: 5}}>
                <QuickSandSemiBold>{props.numerator} / {props.denominator} </QuickSandSemiBold>
            ...
            <View style={{marginVertical: 10, marginLeft: 5, position: 'absolute',bottom: 0}}>
            <QuickSandLight style={{fontSize: 15, color: colors.black}}>{props.text}</QuickSandLight>
            </View>
        </View>
    )
}
