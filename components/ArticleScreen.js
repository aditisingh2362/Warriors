...
function ArticleScreen({ route }) {
    const {id, img_uri, title, description, content,publisher}=route.params;
    ...
    <SafeAreaView style={styles.saveArea}>
      <Animated.ScrollView
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', padding: 10}}>
            ...
            />
            <Text style={styles.textWriter}>{publisher}</Text>
            <Text style={styles.textDate} >
                <Entypo name="dot-single" style={{fontWeight: 'bold'}} color={colors.gray}/> {description}
            </Text>
        </View>
